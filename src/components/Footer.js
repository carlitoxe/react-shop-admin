      ...
      <div class="mx-auto w-full max-w-screen-xl">
        <div class="px-4 py-6 text-center md:flex md:items-center md:justify-between">
          <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">
            © 2023 Made by{' '}
            <a href="https://github.com/carlitoxe" className="text-blue-500 hover:text-blue-300" target="_blank">
              carlitoxe
            </a>
            . All Rights Reserved.
          </span>
          <div class="flex mt-4 space-x-5 justify-center items-center sm:justify-center md:mt-0">
