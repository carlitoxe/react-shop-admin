...
export default function Dashboard() {
  ...
  return (
    <>
      <Head>
        <title>Dashboard - React Shop App</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <Chart className="mb-8 mt-2" chartData={data} />
      <div>
        <h2 className="text-2xl text-center mt-10 text-gray-300">
          Total items: <span className="text-white">{totalProducts}</span>{' '}
        </h2>
        <h2 className="text-2xl text-center mt-2 text-gray-300">
          Total value: <span className="text-green-500 font-medium">${totalPrices}</span>
        </h2>
      </div>
    </>
  );
